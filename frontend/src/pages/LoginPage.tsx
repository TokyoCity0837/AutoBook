    ...
    return (
        <div className="authWrap">
            ...
            <div className="authCard">
                ...
                <p className="authSub">Sign in to continue writing</p>

                <form className="authForm" onSubmit={handleSubmit}>
                    <div className="authField">
                        <label className="authLabel">Email or username</label>
                        <input
                            className="authInput"
                            type="text"
                    ...
                    <div className="authField">
                        <div className="authLabelRow">
                            ...
                            <Link to="/forgot" className="authForgot">Forgot password?</Link>
                        </div>
                        <div className="authInputWrap">
                            <input
                                ...
                                required
                            />
                            <button type="button" className="authEye" onClick={() => setShowPass(s => !s)}>
                                {showPass
                    ...
                    <button className={`authBtn${loading ? ' loading' : ''}`} type="submit" disabled={loading}>
                        {loading ? <span className="authSpinner" /> : 'Login'}
                    </button>
                </form>
                ...
                <p className="authSwitch">
                    Don't have an account? <Link to="/register" className="authSwitchLink">Sign up</Link>
                </p>
            </div>
        </div>
    )
